...
const productSchema = new Schema({
  ...
  category: {
    ...
    enum: ['Electronics', 'Fashion', 'Home & Kitchen', 'Books', 'Sports & Outdoors', 'Beauty & Personal Care'],
    trim: true
  },
  isFlashDeal: {
    type: Boolean,
  ...
  flashPrice: {
    ...
    validate: {
      ...
      message: 'Flash price must be set and less than regular price for flash deals'
    }
  },
  timeLeft: {
    type: Number,
